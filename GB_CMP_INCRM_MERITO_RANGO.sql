...
DESCRIPTION : Obtiene el rango de incremento por merito para mostrar
              al manager en el worksheet
**********************************************************************/
...
IF L_RANGO_MIN = L_RANGO_MAX THEN
    L_RANGO_OUTPUT = L_RANGO_MIN
ELSE
    L_RANGO_OUTPUT = L_RANGO_MIN || ' - ' || L_RANGO_MAX
